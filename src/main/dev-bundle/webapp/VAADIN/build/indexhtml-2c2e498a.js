 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var dt,ut,mt,ht;const L=window,g=o=>{L.emitLitDebugLogEvents&&L.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))};let ln=0,Ge;(dt=L.litIssuedWarnings)!==null&&dt!==void 0||(L.litIssuedWarnings=new Set),Ge=(o,e)=>{e+=o?` See https://lit.dev/msg/${o} for more information.`:"",L.litIssuedWarnings.has(e)||(console.warn(e),L.litIssuedWarnings.add(e))},Ge("dev-mode","Lit is in dev mode. Not recommended for production!");const A=!((ut=L.ShadyDOM)===null||ut===void 0)&&ut.inUse&&((mt=L.ShadyDOM)===null||mt===void 0?void 0:mt.noPatch)===!0?L.ShadyDOM.wrap:o=>o,ue=L.trustedTypes,fo=ue?ue.createPolicy("lit-html",{createHTML:o=>o}):void 0,cn=o=>o,Ye=(o,e,t)=>cn,dn=o=>{if(oe!==Ye)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");oe=o},un=()=>{oe=Ye},Nt=(o,e,t)=>oe(o,e,t),Lt="$lit$",W=`lit$${String(Math.random()).slice(9)}$`,Ho="?"+W,mn=`<${Ho}>`,ee=document,_e=()=>ee.createComment(""),Se=o=>o===null||typeof o!="object"&&typeof o!="function",jo=Array.isArray,hn=o=>jo(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",pt=`[ 	
\f\r]`,pn=`[^ 	
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ln=(o,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,o)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,o)}},In=(o,e,t)=>{e.constructor.createProperty(t,o)};function _(o){return(e,t)=>t!==void 0?In(o,e,t):Ln(o,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pn=({finisher:o,descriptor:e})=>(t,i)=>{var n;if(i!==void 0){const r=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),o==null||o(r,i)}else{const r=(n=t.originalKey)!==null&&n!==void 0?n:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:{...t,key:r};return o!=null&&(s.finisher=function(l){o(l,r)}),s}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function An(o,e){return Pn({descriptor:t=>{const i={get(){var n,r;return(r=(n=this.renderRoot)===null||n===void 0?void 0:n.querySelector(o))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const n=typeof t=="symbol"?Symbol():`__${t}`;i.get=function(){var r,s;return this[n]===void 0&&(this[n]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(o))!==null&&s!==void 0?s:null),this[n]}}return i}})}/**
 * @license
...
`,y=class x extends ie{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[b`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,Fe(()=>import("./component-picker-2bc931f2.js"),["./component-picker-2bc931f2.js","./custom-element-1c6555a1.js"],import.meta.url)}}
        >
 ...
 */const Zo=[];function ei(o){return o&&Object.prototype.hasOwnProperty.call(o,"__themes")}function ir(o){return ei(customElements.get(o))}function nr(o=[]){return[o].flat(1/0).filter(e=>e instanceof zt?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function Xe(o,e,t={}){o&&ir(o)&&console.warn(`The custom element definition for "${o}"
      ...
      importing the corresponding custom element.`),e=nr(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(o,e,t):Zo.push({themeFor:o,styles:e,include:t.include,moduleId:t.moduleId})}function It(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Zo}function rr(o,e){return(o||"").split(" ").some(t=>new RegExp(`^${t.split("*").join(".*")}$`,"u").test(e))}function sr(o=""){let e=0;return o.startsWith("lumo-")||o.startsWith("material-")?e=1:o.startsWith("vaadin-")&&(e=2),e}function ti(o){const e=[];return o.include&&[].concat(o.include).forEach(t=>{const i=It().find(n=>n.moduleId===t);i?e.push(...ti(i),...i.styles):console.warn(`Included moduleId ${t} not found in style registry`)},o.styles),e}function ar(o,e){const t=document.createElement("style");t.innerHTML=o.map(i=>i.cssText).join(`
`),e.content.appendChild(t)}function lr(o){const e=`${o}-default-theme`,t=It().filter(i=>i.moduleId!==e&&rr(i.themeFor,o)).map(i=>({...i,styles:[...ti(i),...i.styles],includePriority:sr(i.moduleId)})).sort((i,n)=>n.includePriority-i.includePriority);return t.length>0?t:It().filter(i=>i.moduleId===e)}const Tr=o=>class extends or(o){static finalize(){if(super.finalize(),this.elementStyles)return;const t=this.prototype._template;!t||ei(this)||ar(this.getStylesForThis(),t)}static finalizeStyles(t){const i=this.getStylesForThis();return t?[...super.finalizeStyles(t),...i]:i}static getStylesForThis(){const t=Object.getPrototypeOf(this.prototype),i=(t?t.constructor.__themes:[])||[];this.__themes=[...i,...lr(this.is)];const n=this.__themes.flatMap(r=>r.styles);return n.filter((r,s)=>s===n.lastIndexOf(r))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cr=b`
...
${br}
${xr}
`;Xe("",di,{moduleId:"lumo-utility"});const ye=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const wr=o=>{document._vaadintheme_webgames_componentCss||(document._vaadintheme_webgames_componentCss=!0),ye(oi.cssText,o),ye(ri.cssText,o),ye(si.cssText,o),ye(ci.cssText,o),ye(di.cssText,o)},_r=wr;_r(document);export{Dn as D,ie as L,zn as P,Tr as T,or as a,Ue as b,b as c,te as d,Mn as e,ri as f,Zo as g,R as h,Zn as i,fe as j,S as n,_ as p,An as q,Xe as r,Er as s,oi as t,nn as u};
